...
app.get('/api/places', async (req, res) => {
    const { center, radius, googleMapsApiKey } = req.query;
    
    try {
      const response = await fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${center}&radius=${radius}&type=place_type&keyword=restaurant&key=${googleMapsApiKey}`);
